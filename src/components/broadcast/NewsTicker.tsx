...
export function NewsTicker({ items, speed = 'medium' }: { items: TickerItem[]; speed?: string }) {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-20 bg-black/85 backdrop-blur-sm border-t border-vred/40 overflow-hidden h-9 flex items-center">
